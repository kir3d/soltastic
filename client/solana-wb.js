...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/rng.js
function rng() {
  if (!getRandomValues) {
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/regex.js
var regex_default;
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/validate.js
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/stringify.js
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/v1.js
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/parse.js
function parse(uuid) {
  if (!validate_default(uuid)) {
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/v35.js
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/md5.js
function md5(bytes) {
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/v3.js
var v3, v3_default;
var init_v3 = __esm({
  "node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/v3.js"() {
    init_process();
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/v4.js
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/sha1.js
function f(s, x, y, z) {
  switch (s) {
    case 0:
      return x & y ^ ~x & z;
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/v5.js
var v5, v5_default;
var init_v5 = __esm({
  "node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/v5.js"() {
    init_process();
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/nil.js
var nil_default;
var init_nil = __esm({
  "node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/nil.js"() {
    init_process();
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/version.js
...
// node_modules/@solana/web3.js/node_modules/uuid/dist/esm-browser/index.js
...
// node_modules/@solana/web3.js/node_modules/jayson/lib/generateRequest.js
var require_generateRequest = __commonJS({
  "node_modules/@solana/web3.js/node_modules/jayson/lib/generateRequest.js"(exports, module) {
    "use strict";
    init_process();
    init_buffer();
...
// node_modules/@solana/web3.js/node_modules/jayson/lib/client/browser/index.js
var require_browser = __commonJS({
  "node_modules/@solana/web3.js/node_modules/jayson/lib/client/browser/index.js"(exports, module) {
    "use strict";
    init_process();
    init_buffer();
    var uuid = (init_esm_browser(), __toCommonJS(esm_browser_exports)).v4;
...
init_process();
init_buffer();
var import_buffer41 = __toESM(require_buffer());
...
function assert(value, struct4, message) {
...
var toBuffer = (arr) => {
  if (import_buffer41.Buffer.isBuffer(arr)) {
    return arr;
  } else if (arr instanceof Uint8Array) {
    return import_buffer41.Buffer.from(arr.buffer, arr.byteOffset, arr.byteLength);
  } else {
    return import_buffer41.Buffer.from(arr);
  }
};
var Struct2 = class {
  ...
  encode() {
    return import_buffer41.Buffer.from((0, import_borsh.serialize)(SOLANA_SCHEMA, this));
  }
  static decode(data) {
...
var PublicKey = class _PublicKey2 extends Struct2 {
   ...
   */
  toBuffer() {
    const b = this._bn.toArrayLike(import_buffer41.Buffer);
    if (b.length === PUBLIC_KEY_LENGTH) {
      return b;
    }
    const zeroPad = import_buffer41.Buffer.alloc(32);
  ...
  static async createWithSeed(fromPublicKey, seed, programId) {
    const buffer = import_buffer41.Buffer.concat([fromPublicKey.toBuffer(), import_buffer41.Buffer.from(seed), programId.toBuffer()]);
  ...
  static createProgramAddressSync(seeds, programId) {
    let buffer = import_buffer41.Buffer.alloc(0);
    seeds.forEach(function(seed) {
      if (seed.length > MAX_SEED_LENGTH) {
        throw new TypeError(`Max seed length exceeded`);
      }
      buffer = import_buffer41.Buffer.concat([buffer, toBuffer(seed)]);
    });
    buffer = import_buffer41.Buffer.concat([buffer, programId.toBuffer(), import_buffer41.Buffer.from("ProgramDerivedAddress")]);
    const publicKeyBytes = sha2562(buffer);
  ...
  static findProgramAddressSync(seeds, programId) {
    ...
    while (nonce != 0) {
      try {
        const seedsWithNonce = seeds.concat(import_buffer41.Buffer.from([nonce]));
...
var rustString = (property = "string") => {
  ...
  rslShim.encode = (str, b, offset2) => {
    const data = {
      chars: import_buffer41.Buffer.from(str, "utf8")
    };
    return _encode(data, b, offset2);
  };
  rslShim.alloc = (str) => {
    return BufferLayout.u32().span + BufferLayout.u32().span + import_buffer41.Buffer.from(str, "utf8").length;
  };
  return rslShim;
};
...
var Message = class _Message {
  ...
  serialize() {
    ...
    const instructions = this.instructions.map((instruction) => {
      ...
      return {
        programIdIndex,
        keyIndicesCount: import_buffer41.Buffer.from(keyIndicesCount),
        keyIndices: accounts,
        dataLength: import_buffer41.Buffer.from(dataCount),
        data
      };
    });
    let instructionCount = [];
    encodeLength(instructionCount, instructions.length);
    let instructionBuffer = import_buffer41.Buffer.alloc(PACKET_DATA_SIZE);
    import_buffer41.Buffer.from(instructionCount).copy(instructionBuffer);
    ...
    const transaction = {
      numRequiredSignatures: import_buffer41.Buffer.from([this.header.numRequiredSignatures]),
      numReadonlySignedAccounts: import_buffer41.Buffer.from([this.header.numReadonlySignedAccounts]),
      numReadonlyUnsignedAccounts: import_buffer41.Buffer.from([this.header.numReadonlyUnsignedAccounts]),
      keyCount: import_buffer41.Buffer.from(keyCount),
      keys: this.accountKeys.map((key) => toBuffer(key.toBytes())),
      recentBlockhash: import_bs58.default.decode(this.recentBlockhash)
    };
    let signData = import_buffer41.Buffer.alloc(2048);
  ...
  static from(buffer) {
    ...
    for (let i = 0; i < accountCount; i++) {
      ...
      accountKeys.push(new PublicKey(import_buffer41.Buffer.from(account)));
    }
    ...
    for (let i = 0; i < instructionCount; i++) {
      ...
      const data = import_bs58.default.encode(import_buffer41.Buffer.from(dataSlice));
      instructions.push({
        programIdIndex,
        accounts,
        data
    ...
    const messageArgs = {
      ...
      recentBlockhash: import_bs58.default.encode(import_buffer41.Buffer.from(recentBlockhash)),
      accountKeys,
      instructions
    };
...
var DEFAULT_SIGNATURE = import_buffer41.Buffer.alloc(SIGNATURE_LENGTH_IN_BYTES).fill(0);
var TransactionInstruction = class {
  constructor(opts) {
    this.keys = void 0;
    this.programId = void 0;
    this.data = import_buffer41.Buffer.alloc(0);
...
var Transaction = class _Transaction {
  ...
  _addSignature(pubkey, signature) {
    ...
    this.signatures[index].signature = import_buffer41.Buffer.from(signature);
  }
  /**
...
Missing signature for public key${sigErrors.missing.length === 1 ? "" : "(s)"} [\`${sigErrors.missing.map((p) => p.toBase58()).join("`, `")}\`].`;
  ...
  _serialize(signData) {
    ...
    const wireTransaction = import_buffer41.Buffer.alloc(transactionLength);
    assert2(signatures.length < 256);
    import_buffer41.Buffer.from(signatureCount).copy(wireTransaction, 0);
    signatures.forEach(({
      signature
    }, index) => {
      if (signature !== null) {
        assert2(signature.length === 64, `signature has invalid length`);
        import_buffer41.Buffer.from(signature).copy(wireTransaction, signatureCount.length + index * 64);
      }
    });
  ...
  static from(buffer) {
    ...
    for (let i = 0; i < signatureCount; i++) {
      ...
      signatures.push(import_bs58.default.encode(import_buffer41.Buffer.from(signature)));
    }
...
function encodeData(type2, fields) {
  ...
  const data = import_buffer41.Buffer.alloc(allocLength);
...
var Loader = class _Loader {
  ...
  static async load(connection, payer, program, programId, data) {
    ...
    while (array2.length > 0) {
      ...
      const data2 = import_buffer41.Buffer.alloc(chunkSize + 16);
      dataLayout.encode({
        instruction: 0,
        // Load instruction
        offset: offset2,
    ...
    await Promise.all(transactions);
    {
      ...
      const data2 = import_buffer41.Buffer.alloc(dataLayout2.span);
      dataLayout2.encode({
        instruction: 1
...
var BufferFromRawAccountData = coerce(instance(import_buffer41.Buffer), RawAccountDataResult, (value) => import_buffer41.Buffer.from(value[0], "base64"));
...
var ParsedOrRawAccountData = coerce(union([instance(import_buffer41.Buffer), ParsedAccountDataResult]), union([RawAccountDataResult, ParsedAccountDataResult]), (value) => {
  if (Array.isArray(value)) {
...
var Ed25519Program = class _Ed25519Program {
  ...
  static createInstructionWithPublicKey(params) {
    ...
    const instructionData = import_buffer41.Buffer.alloc(messageDataOffset + message.length);
...
var Secp256k1Program = class _Secp256k1Program {
  ...
  static publicKeyToEthAddress(publicKey3) {
    ...
    try {
      return import_buffer41.Buffer.from(keccak_256(toBuffer(publicKey3))).slice(-ETHEREUM_ADDRESS_BYTES);
    } catch (error) {
  ...
  static createInstructionWithEthAddress(params) {
    ...
    if (typeof rawAddress === "string") {
      if (rawAddress.startsWith("0x")) {
        ethAddress = import_buffer41.Buffer.from(rawAddress.substr(2), "hex");
      } else {
        ethAddress = import_buffer41.Buffer.from(rawAddress, "hex");
      }
    } else {
      ethAddress = rawAddress;
    }
    ...
    const numSignatures = 1;
    const instructionData = import_buffer41.Buffer.alloc(SECP256K1_INSTRUCTION_LAYOUT.span + message.length);
  ...
  static createInstructionWithPrivateKey(params) {
    ...
    try {
      ...
      const messageHash = import_buffer41.Buffer.from(keccak_256(toBuffer(message)));
...
var bigIntBE = (length) => (property) => {
  ...
  bigIntLayout.decode = (buffer, offset2) => {
    const src = decode(buffer, offset2);
    return (0, import_bigint_buffer.toBigIntBE)(import_buffer.Buffer.from(src));
  };
  bigIntLayout.encode = (bigInt2, buffer, offset2) => {
...
function createTransferInstruction(source, destination, owner, amount, multiSigners = [], programId = TOKEN_PROGRAM_ID) {
  ...
  const data = import_buffer.Buffer.alloc(transferInstructionData.span);
